...
class LoginClass:
    def __init__(self):
        ...
        self.window.geometry("%dx%d+%d+%d"%(w1,h1,sx,sy)) #w,h,x,y
        ...
        self.b = Image.open("images//login8.jpeg").resize((w1,h1))
        ...
        self.hdlbl = Label(self.window,text="Welcome to Hotel Management System",background=mycolor2,
                           font=("Georgia",25,'bold'),relief='groove',borderwidth=10,foreground='white')
        ...
        #-------------- placements -----------------------------------------------
        self.hdlbl.place(x=0,y=0,width=w1,height=90)
        x1 = w1/2 -200
        y1 = 150
        ...
        y1+=y_diff
        self.b1.place(x=x1,y=y1,width=x_diff+x_diff+50,height=40)
    ...
    def checkData(self):
        try:
            ...
            if data:
                ...
                utype=data[2]
                self.window.destroy()
                from homepage import HotelManagementSystem
                HotelManagementSystem(uname,utype)
