...
class Report1Class:
    def __init__(self,home_window):
        ...
        self.mytable.column("#1",width=175,anchor='center')
        self.mytable.column("#2",width=175,anchor='center')
        self.mytable.column("#3",width=175,anchor='center')
        self.mytable.column("#4",width=175,anchor='center')
        self.mytable.column("#5",width=175,anchor='center')
        self.mytable.column("#6",width=175,anchor='center')
        self.mytable.column("#7",width=175,anchor='center')
