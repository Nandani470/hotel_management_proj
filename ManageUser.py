...
class UserClass:
    def __init__(self,home_window):
        ...
        #self.b6 = Button(self.window,text="Reset",background=mycolor2,foreground='white',font=myfont1,command=self.resetDataData)
        ...
        x_diff = 170
        y_diff = 40
        self.hdlbl.place(x=0, y=0, width=w1 + 265, height=60)

        self.L1.place(x=x1,y=y1)
        self.t1.place(x=x1+x_diff,y=y1)
        self.b4.place(x=x1+x_diff+x_diff+50,y=y1,width=100,height=30)
        ...
        self.c1.place(x=x1+x_diff,y=y1,width=205)
        self.b5.place(x=x1+x_diff+x_diff+50,y=y1,width=100,height=30)
        y1+=y_diff
        self.b1.place(x=x1,y=y1,width=150,height=40)
        self.b2.place(x=x1+x_diff+10,y=y1,width=150,height=40)
        self.b3.place(x=x1+x_diff+x_diff+20,y=y1,width=150,height=40)
        #self.b6.place(x=x1 + x_diff + x_diff + 20, y=y1, width=100, height=40)
